...
#if USB_MODE_1D1
	0x10, 0x01,             //bcdUSB_cdc: version 1.1
#elif USB_MODE_2D0
...
#if USB_MODE_1D1
	0x40, 0x00,             //wMaxPacketSize字段。该端点的最大包长。64字节
#elif USB_MODE_2D0
...
#if USB_MODE_1D1
	0x40, 0x00,             //wMaxPacketSize字段。该端点的最大包长。端点2的最大包长为64字节。注意低字节在先。
#elif USB_MODE_2D0
...
const UINT8 USB_cdc_String_Descriptor[] =
{
	//Device (0x1a bytes)
